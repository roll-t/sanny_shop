        ...
        <div class="card-header pb-0 p-3">
            <div class="row">
                ...
                <div class="col-6 text-end btn-add-new">
                    <a class="btn bg-gradient-dark mb-0" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New Material</a>
                </div>
                <!-- Modal -->
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <input class="_WEB_ROOT" type="hidden" value="<?php echo _WEB_ROOT ?>">
                    <form action="<?php echo _WEB_ROOT ?>/admin/material/add" class="form-add-category" method="post">
                    <input type="hidden" name="cl_id" class="id-hidden" value="">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Material name.</label>
                                        <input name="cl_ten" type="text" class="form-control border border-2 p-2 category-name" id="exampleFormControlInput1" placeholder="Enter frist category name">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12  cursor-pointer">
                            <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                ...
                                <span class="ms-auto">
                                    ...
                                    <a class="delete-category" href="' . _WEB_ROOT . '/admin/material/delete?id=' . $value['cl_id'] . '">
...
<script>
    ...
    btn_add_new.addEventListener("click",e=>{
        form.action=_WEB_ROOT+"/admin/material/add";
    })
    ...
    edit_category.forEach(items=>{
        items.addEventListener("click",e=>{
            ...
            form.action=_WEB_ROOT+"/admin/material/edit";
